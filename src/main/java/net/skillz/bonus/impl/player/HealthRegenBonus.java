...
public class HealthRegenBonus extends Bonus {
    public static final Identifier ID = BonusManager.id("health_regen");
    ...
    public void run(PlayerEntity player, float value) {
        player.heal(value * ConfigInit.MAIN.BONUSES.healthRegenBonus);
    }
}
